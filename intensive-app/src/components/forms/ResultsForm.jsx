...
const ResultsForm = ({
  data: { firstName, lastName, birthday, phone, site, about, stack, lastProject },
}) => {
  return (
    <div className={style.container}>
      ...
      <div className={style.block}>
        ...
        <div className={style.element}>
          <div className={style.element_title}> {about.title}</div> :{" "}
          <p className={style.areaField}>{about.value}</p>
        </div>
        <div className={style.element}>
          <div className={style.element_title}> {stack.title}</div> :{" "}
          <p className={style.areaField}>{stack.value}</p>
        </div>
        <div className={style.element}>
